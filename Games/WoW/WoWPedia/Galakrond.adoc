...
-   [![Priest](https://static.wikia.nocookie.net/wowpedia/images/3/37/ClassIcon_priest.png/revision/latest/scale-to-width-down/16?cb=20170130100912)](https://wowpedia.fandom.com/wiki/Priest "Priest") [Galakrond, the Unspeakable](https://hearthstone.fandom.com/wiki/Galakrond,_the_Unspeakable "hswiki:Galakrond, the Unspeakable"), raised by [Madame Lazul](https://hearthstone.fandom.com/wiki/Madame_Lazul_(minion) "hswiki:Madame Lazul (minion)") and corrupted by the xref:OldGod.adoc[OldGod]. Flavor text: _Lazul called Galakrond's name, her voice echoed by whispers from the deep. Both of Galakrond's eyes opened... and then other eyes opened, as well._
